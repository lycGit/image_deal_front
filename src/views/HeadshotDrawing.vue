...
const maleAvatars = ref([
  {
    ...
    description: '经典商务正装',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为藏青色单排扣西装、白色衬衫和海军蓝斜纹领带,将发型整理得整洁商务。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-2.jpg',
    description: '面试/求职标准',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为浅蓝色牛津纺衬衫并系深色领带,将发型整理得清爽干净。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-3.jpg',
    description: 'IT/科技行业',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为深灰色Polo衫或简约圆领毛衣,将发型整理得自然整洁。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-4.jpg',
    description: '公务员/体制内',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为白色或浅蓝色衬衫(不系领带或系保守领带),将发型整理得规整干净。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式'
  },
  {
    image: '/images/headerTemplate/male-5.jpg',
    description: '金融法律权威',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为深色（黑色或藏青色）西装并系温莎结领带,将发型整理得严谨规整。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-6.jpg',
    description: '学生证/毕业照',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为白色衬衫或学院风毛衣,将发型整理得自然青春。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
  ...
  },
  {
    ...
    description: '文艺工作者',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为深色高领毛衣或棉麻衬衫,将发型整理得略有层次感。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-9.jpg',
    description: '蓝底证件标准',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为白色或浅色有领上衣（与蓝色背景形成对比）,将发型整理得干净利落。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-10.jpg',
    description: '白底通用款',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为深色有领上衣（如深蓝、深灰衬衫,使轮廓清晰）,将发型整理得规整。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-11.jpg',
    description: '红底喜庆感',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为深色西装或黑色毛衣,将发型整理得庄重得体。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-12.jpg',
    description: '资深专家型',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为休闲西装外套（不系扣）内搭T恤,将发型整理得自然。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-13.jpg',
    description: '飞行员/军警类',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为制服衬衫（如白色或蓝色）并佩戴肩章,将发型整理得标准硬朗。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-14.jpg',
    description: '服务业标准',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为统一制服衬衫并系领带,将发型整理得干净整齐。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-15.jpg',
    description: '阳光运动风',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为纯色有领运动T恤或立领夹克,将发型整理得清爽阳光。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-16.jpg',
    description: '简洁休闲感',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为纯色亨利衫或休闲T恤（适合非正式用途）,将发型整理得简洁。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-17.jpg',
    description: '艺术家/设计师',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为黑色衬衫或深色牛仔衬衫,将发型整理得个性但不夸张。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
    image: '/images/headerTemplate/male-18.jpg',
    description: '冬季厚装',
    prompt: '保持人物面部特征完全不变,基于上传的参考图,仅将服装修改为深色V领毛衣内搭衬衫并露出领子,将发型整理得规整。确保修改后的人物五官、脸型、皮肤纹理、表情、眼神方向与原始图片完全一致,仅改变衣物和发型样式。'
  },
  {
